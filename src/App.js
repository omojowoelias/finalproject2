...
import React from 'react';                    //react is not defined (import it)
import  Form from "./app_component/form.component";                                             // API_ key is not defined 
import './App.css';
...
class App extends React.Component {
  constructor(){
    ...
    //this.getWeather(); remove this method & passing e.event.target
    this.weatherIcon={
  ...
  getWeather = async (e) =>{
    ...
    if(city && country){
      ...
      const response = await api_call.json(); //converts the data to json format.
